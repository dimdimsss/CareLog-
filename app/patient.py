...
class Patient(User):
    ...
    def __init__(self, user_id, password, name, role, symptoms, personal_notes, preferences, logs=None): # Im not sure if we need role or password on object creation, might be removeable and assigned default values in super
